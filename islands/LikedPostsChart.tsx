...
export default function LikedPostsChartIsland(
  ...
  new Chart("likedPostsChart", {
    type: "line",
    data: {
      labels,
      datasets: [{
        label: "Posts Liked Per Day",
        data: values,
  ...
  return (
    <>
    <canvas id="likedPostsChart" style="width:100%;max-width:700px"></canvas>
    </>
  );
}
